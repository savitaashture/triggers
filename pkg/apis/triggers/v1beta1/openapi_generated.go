		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"personalAccessToken": {
						SchemaProps: spec.SchemaProps{
							Description: "This param/variable is required for private repositories or when either EnableOrgMemberCheck, EnableRepoMemberCheck are set to true",
							Ref:         ref("github.com/tektoncd/triggers/pkg/apis/triggers/v1beta1.SecretRef"),
						},
					},
					"enableOrgMemberCheck": {
						SchemaProps: spec.SchemaProps{
							Description: "Set this as true to allow org members to submit or comment on PR to proceed",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"enableRepoMemberCheck": {
						SchemaProps: spec.SchemaProps{
							Description: "Set this as true to allow repo members to submit or comment on PR to proceed",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
